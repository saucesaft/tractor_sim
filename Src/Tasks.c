/*
* File: Tasks.c
* Declares all Tasks and Initialization of Tasks as functions to be called in the main.c file and arrange
* their runs using a scheduler.
*/
#include <stdint.h>
#include "Tasks.h"
#include "main.h"
...
/*
	Configure pins for reading the keypad and the potentiometer
*/
